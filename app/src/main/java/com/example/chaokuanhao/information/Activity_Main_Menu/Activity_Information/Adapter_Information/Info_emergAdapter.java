...
public class Info_emergAdapter extends RecyclerView.Adapter<Info_emergAdapter.ViewHolder> implements View.OnClickListener{
    private ArrayList<Info_emergData> _data;
    private OnItemClickListener mOnItemClickListener = null;

    public Info_emergAdapter(ArrayList<Info_emergData> d) { _data = d;}
    ...
    public ArrayList<Info_emergData> getSeleted(){
        ArrayList<Info_emergData> ans = new ArrayList<>();
        for(int i = 0; i < _data.size(); ++i)
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Info_emergData temp = _data.get(position);
