...
public final class Daily_Reminder_News extends Fragment implements ISlideBackgroundColorHolder{

    private final String TAG = Daily_Reminder_News.class.getSimpleName();
    private View mView;
    /**
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_daily_reminder_news, container, false);
